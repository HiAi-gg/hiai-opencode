...
/**
 * Agent category for grouping in Bob prompt sections
 */
...
/**
 * Delegation trigger for Bob prompt's Delegation Table
 */
...
/**
 * Metadata for generating Bob prompt sections dynamically
 * This allows adding/removing agents without manually updating the Bob prompt
 */
export interface AgentPromptMetadata {
  ...
  /** Optional dedicated prompt section (markdown) - for agents like Logician that have special sections */
