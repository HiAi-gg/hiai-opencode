# src/agents/strategist/ -- Strategic Planner

**Generated:** 2026-04-11

## OVERVIEW

11 files. Strategist agent -- interview-mode strategic planner. Reads codebase, questions user, builds detailed work plan before any code is written. Markdown-only output (enforced by `strategist-md-only` hook).
