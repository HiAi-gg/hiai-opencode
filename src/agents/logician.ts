...
/**
 * Default Logician prompt - used for Claude and other non-GPT models.
...
/**
 * GPT-5.4 Optimized Logician System Prompt
 *
...
export function createLogicianAgent(model: string): AgentConfig {
  ...
  const base = {
    description:
      "Read-only consultation agent. High-IQ reasoning specialist for debugging hard problems and high-difficulty architecture design. (Logician - HiaiOpenCode)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
