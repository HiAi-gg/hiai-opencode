...
| **Researcher** | Codebase & docs search | Finding code patterns, external docs (Context7/Firecrawl), codebase exploration | \`task(subagent_type="researcher", load_skills=[], run_in_background=true, ...)\` |
