...
2. **Check MemPalace** for existing brand decisions, tone-of-voice guidelines, and prior copy decisions. Search with \`mcp__mempalace__mempalace_search\`. For project architecture context, use \`skill_mcp({ mcp_name: "agent-skills", tool_name: "skill", arguments: { name: "supabase-postgres-best-practices" }})\`.
