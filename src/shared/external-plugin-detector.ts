/**
 * Detects external plugins that may conflict with hiai-opencode features.
...
/**
 * Known notification plugins that conflict with hiai-opencode's session-notification.
...
/**
 * Known skill plugins that conflict with hiai-opencode's skill loading.
