/**
 * Unified system directive prefix for hiai-opencode internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OH-MY-OPENCODE - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: HIAI-OPENCODE";
...
/**
 * Checks if a message starts with the hiai-opencode system directive prefix.
