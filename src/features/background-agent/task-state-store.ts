...
export class TaskStateStore {
  ...
  readonly completedTaskSummaries: Map<string, BackgroundTaskNotificationTask[]> = new Map()
  readonly idleDeferralTimers: Map<string, ReturnType<typeof setTimeout>> = new Map()
  ...
  setIdleDeferralTimer(taskId: string, timer: ReturnType<typeof setTimeout>): void {
  ...
  getCompletedTaskSummaries(sessionID: string): BackgroundTaskNotificationTask[] | undefined {
    return this.completedTaskSummaries.get(sessionID)
  }

  setCompletedTaskSummaries(sessionID: string, summaries: BackgroundTaskNotificationTask[]): void {
