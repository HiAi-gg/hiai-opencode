// Auto-generated from distill.txt — DO NOT edit manually.
// Source: src/features/dream-distill/distill.txt

export const DISTILL_PROMPT = `# Distill: Workflow Packaging
