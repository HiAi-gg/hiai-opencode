...
import {
  BOULDER_DIR,
  BOULDER_FILE,
  STRATEGIST_PLANS_DIR,
  BOULDER_REGISTRY_DIR,
  LEGACY_BOULDER_FILE,
  NOTEPAD_DIR,
} from "./constants";
 ...
 */
export function readBoulderForPlan(
  directory: string,
  planName: string,
): BoulderState | null {
 ...
 */
export function deleteBoulderForPlan(
  directory: string,
  planName: string,
): boolean {
  validatePlanName(planName);
 ...
 */
export function findPlanNameForSession(
  directory: string,
  sessionId: string,
): string | null {
  const plans = getActivePlans(directory);
 ...
 */
export function hasConflictingPlan(
  directory: string,
  excludePlanName: string,
): boolean {
  const plans = getActivePlans(directory);
...
const WORKTREE_REGISTRY_REL_DIR = BOULDER_REGISTRY_DIR.replace(
  `${BOULDER_DIR}/`,
  "",
);
 ...
 */
export function deleteBoulderForPlanInWorktree(
  worktreePath: string,
  planName: string,
): boolean {
  validatePlanName(planName);
 ...
 */
export function syncBoulderNotepadsFromWorktree(
  rootDirectory: string,
  worktreePath: string,
): void {
