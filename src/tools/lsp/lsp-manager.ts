...
const INSTALL_HINTS: Record<string, string> = {
  ...
  biome: 'Install: npm install -g @biomejs/biome  or  bun add -g @biomejs/biome',
  ...
  'vscode-html-language-server': 'Install: npm install -g vscode-langservers-extracted',
  'vscode-css-language-server': 'Install: npm install -g vscode-langservers-extracted',
  'vscode-json-language-server': 'Install: npm install -g vscode-langservers-extracted',
  'vue-language-server': 'Install: npm install -g @vue/language-server',
};

export class LSPManager {
  private clients = new Map<string, { client: LSPClient; refCount: number; lastUsed: number }>();
  ...
  getInstallHint(command: string): string {
    return INSTALL_HINTS[command] ?? `Install the "${command}" LSP server manually.`;
  }
