...
export function createCallHiaiAgent(
  ...
  return tool({
    ...
    async execute(args: CallHiaiAgentArgs, toolContext) {
      const toolCtx = toolContext as ToolContextWithMetadata;
      log(
        `[call_hiai_agent] DEPRECATED: call_hiai_agent is deprecated. Use task(agent="...", load_skills=[], run_in_background=...) instead.`,
      );
