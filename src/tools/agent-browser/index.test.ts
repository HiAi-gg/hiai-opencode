...
const mockVisionContext = { agent: 'vision', sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
const mockGeneralContext = { agent: 'general', sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
const mockCriticContext = { agent: 'critic', sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
const mockBobContext = { agent: 'bob', sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
const mockBuildContext = { agent: 'build', sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
const mockUnknownContext = { agent: undefined as unknown as string, sessionID: 's1', messageID: 'm1', directory: '/tmp', worktree: '/tmp', abort: new AbortController().signal, metadata: () => {}, ask: async () => {} };
