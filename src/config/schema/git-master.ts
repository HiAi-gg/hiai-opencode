...
export const GitMasterConfigSchema = z.object({
  /** Add "Ultraworked with Bob" footer to commit messages (default: true). Can be boolean or custom string. */
  commit_footer: z.union([z.boolean(), z.string()]).default(true),
  /** Add "Co-authored-by: Bob" trailer to commit messages (default: true) */
