...
const AGENTS: Entry[] = [
  {
    name: "bob",
    factory: () =>
      createBobAgent(TEST_MODEL, [], [], [], [], false).prompt ?? "",
  },
  {
    name: "coder",
    factory: () =>
      createCoderAgent(TEST_MODEL, [], [], [], [], false).prompt ?? "",
  },
  {
    name: "sub",
    factory: () =>
      createBobJuniorAgentWithOverrides(undefined, TEST_MODEL, false).prompt ??
      "",
  },
  {
    name: "manager",
    factory: () => createManagerAgent({ model: TEST_MODEL }).prompt ?? "",
  },
  {
    name: "researcher",
    factory: () => createResearcherAgent(TEST_MODEL).prompt ?? "",
  },
  {
    name: "designer",
    factory: () => createDesignerAgent(TEST_MODEL).prompt ?? "",
  },
  { name: "writer", factory: () => createWriterAgent(TEST_MODEL).prompt ?? "" },
  {
    name: "vision",
    factory: () => createMultimodalLookerAgent(TEST_MODEL).prompt ?? "",
  },
  { name: "critic", factory: () => createCriticAgent(TEST_MODEL).prompt ?? "" },
  {
    name: "quality-guardian",
    factory: () => createQualityGuardianAgent(TEST_MODEL).prompt ?? "",
  },
];
...
`;
  ...
  console.log(
    `${name.padEnd(20)} ${bytes.toString().padStart(6)} bytes  ${lines.toString().padStart(4)} lines`,
  );
}
